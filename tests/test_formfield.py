...
class RegistrationForm(SuperForm):
    ...
    address_initial = FormField(
        AddressForm, kwargs={"initial": {"street": "Homebase 42", "city": "Supertown"}}
    )
...
class FormFieldTests(TestCase):
    ...
    def test_initial_pass_through(self):
        superform = RegistrationForm(
            initial={"first_name": "Patricia", "address": {"street": "Default Road"}}
        )
        form = superform.forms["address"]
    ...
    def test_initial_pass_through_with_multiple_layers(self):
        superform = RegistrationForm(
            initial={
                "more_addresses": {
                    "address1": {"street": "Fooway", "city": "Testcity"},
                    "address2": {
                        "street": "Barboulevard",
                    },
                }
